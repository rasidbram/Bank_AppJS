...
const account1 = {
	...
	movementsDates: [
		...
		'2021-06-18T17:01:17.194Z',
		'2021-06-22T23:36:17.929Z',
		'2021-06-24T10:51:36.790Z',
	],
	currency: 'GBP',
	locale: 'en-GB', // de-DE
};
...
const startLogOutTimer = function () {
	...
	const timer = setInterval(() => {
		...
		//In each call, print the remaining time tu UI
...
btnLogin.addEventListener('click', function (e) {
	...
	if (currentAccount?.pin === Number(inputLoginPin.value)) {
		...
		// Experimenting API (CREATE DATE AND TIME)
		const now = new Date();
		const options = {
			hour: 'numeric',
			minute: 'numeric',
